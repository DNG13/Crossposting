...
<div class="site-index">
    ...
    <div class="site-index">
        ...
        <p>Про вирішення питань по роботі на сайту читайте <a href="<?= Yii::$app->urlManager->createUrl(['site/help']) ?>">тут</a>.</p>
        <p>Більш детально про конфіденційність на сайті можно дізнатись на <a href="<?= Yii::$app->urlManager->createUrl(['site/privacy']) ?>">цій</a> сторінці.</p>
    </div>
</div>
